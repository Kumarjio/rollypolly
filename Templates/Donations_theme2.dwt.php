...
<link href="../donations/assets/css/theme2.css" rel="stylesheet">
		...
		<nav class="navbar-default navbar-inverse navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="#">Brand</a>
				</div>
	...
	<section>
		<div class="container">
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
					...
					<img class="img-responsive" src="../donations/images/thumb.jpg" alt="">
						<div class="panel-body">
							
							<p class="lead text-danger text-center">
								Special offer title! Limited time only!
							</p>
							<p>
								<a class="btn btn-warning btn-md btn-block" href="#">Buy now</a>
							</p>
						</div>
					</div>
				</div>
			...
			<div class="carousel-inner">
				<div class="item active">
					<img class="img-responsive" src="../donations/images/carouselthumb.jpg" alt="thumb" />
					<div class="carousel-caption">
						Carousel caption. Here goes slide description. Lorem ipsum dolor set amet.
					</div>
				</div>
				<div class="item">
					<img class="img-responsive" src="../donations/images/carouselthumb.jpg" alt="thumb" />
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
					<div class="page-header">
						<h3>
							Store catalog <small>Subtext for header</small>
						</h3>
					</div>
					<div class="row">
		<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
			<div class="panel panel-default">
				...
				<div class="panel-body text-center">
					<h4>
						<a href="#">Here goes product tag line</a>
					</h4>
					<p class="text-danger">
						$100
					</p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-5">
					 <span class="text-right"> <address> <strong>StoreFront, Inc.</strong><br /> 795 Folsom Ave, Suite 600<br /> San Francisco, CA 94107<br /> <abbr title="Phone">P:</abbr> (123) 456-7890</address> <address> <strong>Full Name</strong><br /> <a href="mailto:#">first.last@example.com</a></address></span>
				</div>
			</div>
		</div>
	</section>
