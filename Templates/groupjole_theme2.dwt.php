...
<link href="../groupjole/assets/css/bootstrap.css" rel="stylesheet">
<link href="../groupjole/assets/css/theme2.css" rel="stylesheet">
<link href="../groupjole/assets/css/site.css" rel="stylesheet">
...
<link rel="shortcut icon" href="../groupjole/assets/ico/favicon.ico">
...
<script src="../groupjole/assets/js/ang/app.js"></script>
<!-- Latest compiled and minified JavaScript -->
<script src="../groupjole/assets/js/bootstrap.js"></script>

<script src="../groupjole/assets/js/googleMap.js"></script>
	...
	<section>
		<nav class="navbar-default navbar-inverse navbar-fixed-top" role="navigation">
			<div class="container">
				...
				<?php include('../groupjole/includes/topMenu.php'); ?>
			</div>
		</nav>
	</section>
	<section class="top-section">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<form class="navbar-form ng-pristine ng-valid pull-right" role="search" action="../groupjole/index.php" method="get">
		...
		<div class="container">
			<div class="row">
			    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
					<?php include('../groupjole/includes/offers.php'); ?>
					<?php include('../groupjole/includes/more.php'); ?>
				</div>
                
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-9 hidden-xs">
                    <div class="page-header">
                    <!-- TemplateBeginEditable name="EditRegionSubHead" -->
...
<!-- TemplateBeginEditable name="EditRegion3" -->
					<div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                            <div class="panel panel-default"> <img class="img-responsive" src="../groupjole/images/thumb.jpg" alt="" />
	...
	<section class="custom-footer">
		<div class="container">
			<div class="row">
				...
				<?php include('../groupjole/includes/footerLinks.php'); ?>
				<?php include('../groupjole/includes/bottomAddress.php'); ?>
			</div>
		</div>
	</section>
</div>
