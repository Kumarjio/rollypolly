  ...
  <tr>
    <td valign="top"><table width="100%"  border="0" cellspacing="1" cellpadding="5">
      <tr>
        ...
        <td valign="top"><h2>Procentris ITS Trouble Ticket System </h2> </td>
      </tr>
      <tr>
        <td colspan="2" valign="top"><hr></td>
      </tr>
      <tr>
        <td colspan="2" valign="top"><a href="../index.php">Home</a><?php if(!$_SESSION['MM_Username']) { ?> | <a href="../users/register.php">Register</a> | <a href="../users/login.php">Login</a><?php } ?><?php if($_SESSION['MM_Username']) { ?>           | <a href="../tt/index.php">Create Trouble Ticket</a> | <a href="../tt/mytickets.php">View My Tickets</a> | <a href="../users/edit.php">Edit Details</a> | <a href="../users/logout.php">Logout</a><?php } ?><?php if($_SESSION['MM_UserGroup']=="ITS" || $_SESSION['MM_UserGroup']=="SUPERADMIN") { ?> | <a href="../tt/admin.php?status=Open">Admin</a> | <a href="../tt/search.php">Reports</a> | <a href="../tt/search_it.php">Closed Reports</a><?php } ?>
