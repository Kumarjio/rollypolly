<p>Users must comply with all applicable laws, the <?php echo SITENAME; ?>
 <a href="/about/terms">terms of use</a>, and all posted site rules.</p>
<p>Here is a partial list of goods, services, and content prohibited on craigslist:</p>
<ul>
  ...
  <li>anyone&rsquo;s personal, identifying, confidential or proprietary information</li>
...
<p>Please don't use <?php echo SITENAME; ?>
 for these purposes, and <a href="/about/flag">flag</a> anyone else you see doing so.</p>
<p>Thanks for helping keep craigslist safe and useful for everyone.</p>
