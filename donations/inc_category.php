...
<?php if ($totalRows_rsCategoryLink > 0) { // Show if recordset not empty ?>
  <ul id="cat-navi" class="nav nav-list">
    <li><a href="index.php" class="list-group-item active"> Categories</a></li>
    <li><a href="index.php" class="list-group-item"> View All</a></li>
    <?php foreach ($rsCategoryDetails as $row_rsCategoryLink) { ?>
      <li><a href="index.php?cid=<?php echo $row_rsCategoryLink['category_id']; ?>&cat=<?php echo urlencode($row_rsCategoryLink['category']); ?>" class="list-group-item"> <?php echo $row_rsCategoryLink['category']; ?></a></li>
      <?php } ?>
  </ul>
...
<?php if ($totalRows_rsCategoryLink > 0) { // Show if recordset not empty ?>
  <ul class="dropdown-menu">
            <li>
              <a href="index.php">View All Listings</a>
            </li>
    <?php foreach ($rsCategoryDetails as $row_rsCategoryLink) { ?>
            <li>
              <a href="index.php?cid=<?php echo $row_rsCategoryLink['category_id']; ?>&cat=<?php echo urlencode($row_rsCategoryLink['category']); ?>"><?php echo $row_rsCategoryLink['category']; ?></a>
            </li>
      <?php } ?>
  </ul>
<?php } // Show if recordset not empty ?>
