	...
	*/
	...
	function drawSubNode($parentID){
		if(isset($this->elementArray[$parentID])){			
			...
			for($no=0;$no<count($this->elementArray[$parentID]);$no++){
				echo "<li id=\"node_".$this->elementArray[$parentID][$no][0]."\"><a href=\"#\">".$this->elementArray[$parentID][$no][1]."</a>";	
	...
	function drawTree(){
		...
		for($no=0;$no<count($this->elementArray[0]);$no++){
			echo "<li id=\"node_".$this->elementArray[0][$no][0]."\"><a href=\"#\">".$this->elementArray[0][$no][1]."</a>";		
