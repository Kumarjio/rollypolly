<?php
	$openinviter_settings=array(
		"username"=>"mkhanchandani",
		"private_key"=>"263c1937e2de354be9873f792343388c",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to wc5.org", // wc5.org is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to wc5.org", // wc5.org is the website on your account. If wrong, please update your account at OpenInviter.com
