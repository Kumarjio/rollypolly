...
$pageTitle = 'View Community Postings in '.$pageTitle;
try {
    $error = '';
    $result = array();
    $url = APIHTTPPATH.'/help/community/view?';
        ...
        <div class="col-lg-12">
            <div class="bs-component">
              <ul class="breadcrumb">
                ...
                <li><a href="<?php echo $currentURL; ?>/community/new">Post Community</a></li>
...
<div class="row">
  ...
  foreach ($result['result'] as $k => $v) {
      $link = $currentURL.'/community/detail?community_id='.$v['community_id'];
