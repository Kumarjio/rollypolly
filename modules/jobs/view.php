...
$pageTitle = 'View Jobs in '.$pageTitle;
try {
    $error = '';
    $result = array();
    $url = APIHTTPPATH.'/help/jobs/view?';
...
<div class="row">
        <div class="col-lg-4" style="padding-bottom: 12px">
            <div class="bs-component">
  <b>Category: </b><br />
  ...
  <?php } ?>
        ...
        <div class="col-lg-4" style="padding-bottom: 12px">
            ...
            <input type="checkbox" name="contract" id="contract" value="1" /> telecommute<br />
...
<div class="row">
  ...
  foreach ($result['result'] as $k => $v) {
      $link = $currentURL.'/jobs/detail?job_id='.$v['job_id'];
      echo viewDisplay($link, $v['title'], $v['name'], $v['job_updated_dt']);
    ?>
    <?php
  }
  ?>
