...
$pageTitle = 'View Personals Postings in '.$pageTitle;
try {
    $error = '';
    $result = array();
    $url = APIHTTPPATH.'/help/personals/view?';
        ...
        <div class="col-lg-12">
            <div class="bs-component">
              <ul class="breadcrumb">
                ...
                <li><a href="<?php echo $currentURL; ?>/personals/new">Post Personals</a></li>
...
<div class="row">
  ...
  foreach ($result['result'] as $k => $v) {
      $link = $currentURL.'/personals/detail?personal_id='.$v['personal_id'];
