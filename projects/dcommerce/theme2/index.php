    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">Dcomerce.Com</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <?php if (empty($_SESSION['user'])) { ?>
                        <li>
                            <a href="/users/login"><i class="fa fa-dashboard fa-fw"></i> Login</a>
                        </li>
                        <?php } ?>
                        <?php if (!empty($_SESSION['user'])) { ?>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Horo<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/horo/main">Main</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="/users/login?logout=1">Logout</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
