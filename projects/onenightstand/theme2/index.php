...
<head>
    ...
    <base href="<?php echo HTTPPATH; ?>/theme2/" />
...
<script src="<?php echo HTTPPATH; ?>/js/script.js"></script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo HTTPPATH; ?>">Dcomerce.Com</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="/users/login"><i class="fa fa-user fa-fw"></i> Login</a>
                        <?php } else { ?>
                        <li><a href="/users/settings"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="/users/login?logout=1"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                        <?php } ?>
                    </ul>
                    <!-- /.dropdown-user -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <?php if (empty($_SESSION['user'])) { ?>
                        <li>
                            <a href="<?php echo HTTPPATH; ?>/users/login"><i class="fa fa-dashboard fa-fw"></i> Login</a>
                        </li>
                        <?php } ?>
                        <?php if (!empty($_SESSION['user'])) { ?>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo HTTPPATH; ?>/groups/new">New</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo HTTPPATH; ?>/users/settings">Settings</a>
                                </li>
                                <li>
                                    <a href="<?php echo HTTPPATH; ?>/users/login?logout=1">Logout</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
