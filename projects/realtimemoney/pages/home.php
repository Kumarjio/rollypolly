<div class="header alt vert">
  <div class="container">
    ...
    <h1>Real Money Making</h1>
      <p class="lead">Through Advertisements</p>
      <div>&nbsp;</div>
      <a href="<?php echo HTTPPATH; ?>/getStarted" class="btn btn-default btn-lg">Get Started</a>
  </div>
</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        ...
        <p class="lead">With First Month Fee of $11.24 followed by $1.24 every month.</p>
      </div>
      <div class="col-md-5">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p>More you click, more you earn points. More points you have, more money you will get.</p>
      </div>
    </div>
    <div class="row">
...
<div id="step3" class="blurb">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <h1>Step 3: Become a Member</h1>
        <p class="lead">With First Month Fee of $11.24 followed by $1.24 every month.</p>
      </div>
      <div class="col-md-5">
        <h1 class="pull-right"><i class="icon-mobile-phone icon-3x"></i> <i class="icon-tablet icon-3x"></i> <i class="icon-laptop icon-3x"></i></h1>
