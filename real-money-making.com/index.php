...
?>
<!doctype html>
<html ng-app="RealMoneyMaking">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title><?php echo $pageTitle; ?></title>
<base href="<?php echo HTTPPATH; ?>/" />
<script language="javascript" src="https://ajax.googleapis.com/ajax/libs/angularjs/1.3.15/angular.min.js"></script>
<script language="javascript" src="<?php echo HTTPPATH; ?>/assets/js/ang/app.js"></script>
</head>
