...
web build:
 - http://mootools.net/core/d0ea5889ff87abe49b30bba661a4e5a7

packager build:
 - packager build Core/Core Core/Array Core/String Core/Function Core/Object Core/Event Core/Browser Core/Class Core/Element Core/Element.Style Core/Element.Event Core/Element.Dimensions Core/Fx Core/Fx.Tween Core/Fx.Morph Core/Request Core/Request.HTML Core/Request.JSON Core/Cookie Core/JSON Core/DOMReady
...
}this.prototype[h]=(g)?i:b(this,h,i);}else{Object.merge(this.prototype,h,i);}return this;};


    var d=function(g){ if(!g)console.trace(); g.$prototyping=true;var h=new g;delete g.$prototyping;
