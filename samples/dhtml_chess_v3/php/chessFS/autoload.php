    ...
    function($class) {
        ...
        if ($classes === null) {
            $classes = array(
                ...
                'allchessfstests' => '/tests/AllChessFSTests.php',
                'allchesstests' => '/../chessDB/Tests/AllChessTests.php',
                'alltests' => '/../chessDB/ludoDB/Tests/AllTests.php',
                ...
                'fs_gametest' => '/tests/FS_GameTest.php',
                'fs_testbase' => '/tests/FS_TestBase.php',
