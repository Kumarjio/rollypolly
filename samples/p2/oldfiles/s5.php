...
$initialArrayPosition2 = array(array('my' => 'left', 'at' => 'right top'), array('my' => 'left', 'at' => 'right center'), array('my' => 'left', 'at' => 'right bottom'), array('my' => 'left', 'at' => 'left top'), array('my' => 'left', 'at' => 'left center'), array('my' => 'left', 'at' => 'left bottom'));
?>
<!DOCTYPE html>
<html lang="en">
   ...
   $(function() {
    ...
    var lifetime = 4000;
      ...
      $( "#dialog_<?php echo $row_rsView['id']; ?>_<?php echo $v['detail_id']; ?>" ).dialog({
            autoOpen: false,
            position: { my: "<?php echo $position['my']; ?>", at: "<?php echo $position['at']; ?>", of: '#mapMainImage_<?php echo $row_rsView['id']; ?>', collision: "flipfit", using: function( position ) {
