...
mysql_select_db($database_connChess, $connChess);
$query_rsLeaderBoard = sprintf("SELECT *  FROM  pointCalculation as pc LEFT JOIN players as p ON pc.player_id = p.player_id WHERE pc.tournament_id = %s ORDER BY pc.totalpoints DESC ", GetSQLValueString($colid_rsLeaderBoard, "int"));
...
<div style="float:right">
    ...
    <table border="1" cellpadding="5" cellspacing="0">
        ...
        <?php do { ?>
            <tr>
                <td><?php echo $row_rsLeaderBoard['player_name']; ?></td>
...
<?php if ($totalRows_rsView > 0) { // Show if recordset not empty ?>
    ...
    <table border="1" cellpadding="5" cellspacing="0">
        ...
        ?>
            <tr>
                <td valign="top"><?php echo $row_rsView['id1']; ?>. <?php echo $row_rsView['p1Name']; ?> (<?php if ($row_rsView['p1'] == $row_rsView['white']) echo 'white'; else if ($row_rsView['p1'] == $row_rsView['black']) echo 'black'; ?>)</td>
                <td valign="top"><?php echo $row_rsView['id2']; ?>. <?php echo $row_rsView['p2Name']; ?> (<?php if ($row_rsView['p2'] == $row_rsView['white']) echo 'white'; else if ($row_rsView['p2'] == $row_rsView['black']) echo 'black'; ?>)</td>
